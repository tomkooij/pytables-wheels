...
CMAKE_CONFIGURE_CMD = [
    ...
    "-DHDF5_BUILD_CPP_LIB=OFF", "-DHDF5_BUILD_HL_LIB=OFF",
...
CMAKE_HDF5_LIBRARY_PREFIX = ["-DHDF5_EXTERNAL_LIB_PREFIX=pytables_"]
...
def hdf5_install_cached(install_path):
    if exists(pjoin(install_path, "lib", "hdf5.dll")):
        return True
    if exists(pjoin(install_path, "lib", "pytables_hdf5.dll")):
        return True
    return False
